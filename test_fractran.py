...
def test_Fractran_init():
    assert Fractran([Fraction(3, 10), Fraction(4, 3)]).programme == [
        Fraction(3, 10),
        Fraction(4, 3),
    ]
...
def test_Fractran_run():
    un_fractran = Fractran([Fraction(3, 10), Fraction(4, 3)])
    assert un_fractran.run(15) == 8


def test_Fractran_suite():
    un_fractran = Fractran([Fraction(3, 10), Fraction(4, 3)])
    assert un_fractran.suite(15, 2) == [15, 20]
